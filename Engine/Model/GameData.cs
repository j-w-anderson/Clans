...
namespace Engine.Model
{
    ...
    {
        static public string[,] RegionData = new string[,] {{"0","5","5","0","STEPPE","1,2,3"},
        ...
        static public double[,] ScoreTrack = new double[,] {{85.8,92.6},
        ...
        static public double[,] EpochTrack = new double[,]  {{1,0,92,11},
                                                            {1,1,92,16.5},
                                                            {1,2,92,21.5},
                                                            {1,3,92,27},
                                                            {2,0,92,36},
